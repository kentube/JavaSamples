package my.summer.springbootmongodb.controller;

import java.util.Date;
import java.util.List;
 
import my.summer.springbootmongodb.document.Employee;
import my.summer.springbootmongodb.repository.EmployeeRepository;
import my.summer.springbootmongodb.repository.EmployeeRepositoryCustom;
